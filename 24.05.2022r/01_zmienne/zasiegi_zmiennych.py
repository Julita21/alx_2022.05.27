...
#
# funkcja1()
# # po zakończeniu funkcji nie ma dostępu do zmienych lokalnych wprowadzych w tej funkcji
# # print('b:', b)
#
# ###############
...
def funkcja3():
   #tutaj zmienną globalną przysłaniamy za pomcą zmiennej lokalnej o tej samej nazwie
   c = 200
   print('c:', c)
